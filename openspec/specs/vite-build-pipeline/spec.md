...
Vite-based build system providing a development server with hot module replacement, production builds with optimization and content-hashed filenames, and static asset handling from a public directory.
