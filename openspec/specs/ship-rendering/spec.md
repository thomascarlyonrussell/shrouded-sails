...
## Purpose
Defines how ship classes are visually represented on the board, including hull silhouettes, mast-based rank cues, and deck detail.
...
- **WHEN** a Sloop (type 1, 1x1 footprint) is rendered
...
- **WHEN** a Frigate (type 2, 2x1 footprint) is rendered
...
- **WHEN** a Flagship (type 3, 2x2 footprint) is rendered
